...
export const loginConstants = {
    ...
    UPDATE_LOGIN_STATE_REQUEST: 'UPDATE_LOGIN_STATE_REQUEST',
    UPDATE_LOGIN_STATE_SUCCESS: 'UPDATE_LOGIN_STATE_SUCCESS',
    LOGOUT: 'LOGOUT'
};
...
export const updateExpenseConstants = {
    ...
    CHANGE_EXPENSE_EDIT_INPUT: 'CHANGE_EXPENSE_EDIT_INPUT'
};